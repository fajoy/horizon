...
from openstack_dashboard.dashboards.project.instances.workflows.create_instance import KEYPAIR_IMPORT_URL
from openstack_dashboard.dashboards.project.instances.workflows.create_instance import SetNetwork 
